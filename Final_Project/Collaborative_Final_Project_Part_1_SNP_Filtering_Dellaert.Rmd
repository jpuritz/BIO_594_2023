...
After filtering, kept 334 out of 334 Individuals
Outputting VCF file...
After filtering, kept 94 out of a possible 337 Sites
Run Time = 0.00 seconds

```
mv SNP.TRSdp5p05FHWEmaf05.recode.vcf SNP_FilteredZD.recode.vcf
``

**FINAL FILTERED VCF FILE: SNP_FilteredZD.recode.vcf**