...
| Modeler **Optional Role** |<img src="https://media.tenor.com/AWtZJUecThcAAAAd/starbase-math.gif"   /> |The Modeler must find a model or visualization that captures at least one of the topics discussed in the chapter.  Bonus points if the model is coded in a reproducible RMarkDown document|
