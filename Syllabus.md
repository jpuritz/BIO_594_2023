...
|------|--|--------------|
| Lecturer |<img src="https://media.tenor.com/xR1r8YpN8CsAAAAC/himym-how-i-met-your-mother.gif" height="100" />| The Lecturer must compile a 10-20 min presentation that summarizes and highlights the main topics presented in the chapter.  Every student must be a lecturer for at least one book chapter.|
| Discussion Leader |<img src="https://gifdb.com/images/high/michael-scott-ship-is-hidden-in-leadership-p0zkim2xc9dbkdbs.webp"  height="100" /> | The Discussion Leader must come up with 5 ideas, concepts, or questions to be discussed beforehand.  Discussion questions/topics need to be posted one day before class. Every student must be a lecturer for at least one book chapter.|
...
| Modeler **Optional Role** |<img src="https://media.tenor.com/AWtZJUecThcAAAAd/starbase-math.gif" height="100"> |The Modeler must find a model or visualization that captures at least one of the topics discussed in the chapter.  Bonus points if the model is coded in a reproducible RMarkDown document|
